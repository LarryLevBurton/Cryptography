...
//  Task 4a      
        BigInteger number1 = new BigInteger ("299");
...
//        long randomNumMulti = 1;
        ...
        List<BigInteger> resultsNum = new ArrayList<BigInteger>();

//        List<Integer>[] resultsList = new ArrayList<Integer>; 
//            List<List<Integer>> resultsList = new ArrayList<List<Integer>>();

//        int resultsNum[]= {0,0,0,0};
        int results[] = {0,0,0,0};
        long results3[] = {0,0,0,0};
//        int resultsList[][] = new int[210][];

//        for(int i = 0; i<20; i++){
//                resultsList[i] = results;
//        }
//        resultsList.add(new ArrayList<Integer[]>());
//        resultsList.get(0).add(results);
...
//                //generates the power list (smooth 7)
                resultsList.add(generateSmooth(rNum,3));
                resultsNum.add(randomNumber);

                for(int i = 0; i <(resultsList.size())-1;i++){
//                    for(int p = 0; p < 2; p++){
                        int temp1 = resultsList.get(count)[0] + resultsList.get(i)[0];
                        int temp2 = resultsList.get(count)[1] + resultsList.get(i)[1];
                        int temp3 = resultsList.get(count)[2] + resultsList.get(i)[2];
                        int temp4 = resultsList.get(count)[3] + resultsList.get(i)[3];
                        if(temp1%2 == 0 && temp2%2 == 0 && temp3%2 == 0 && temp4%2 == 0){
                            results[0] = resultsList.get(count)[0] + resultsList.get(i)[0];
                            results[1] = resultsList.get(count)[1] + resultsList.get(i)[1];
                            results[2] = resultsList.get(count)[2] + resultsList.get(i)[2];
                            results[3] = resultsList.get(count)[3] + resultsList.get(i)[3];
                            randomNumMulti = resultsNum.get(count).multiply(resultsNum.get(i));//.add.multiply(randomNumber);
                            notEven = 1;
                    }
                }
                count++;
...
//        // and times them to the previous power. 
        for(int j = 0; j < 4; j++){
            long temp = (long) pow(pwr[j],results[j]);
